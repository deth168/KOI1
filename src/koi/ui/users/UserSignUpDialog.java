...
public class UserSignUpDialog extends JDialog {
	...
	public UserSignUpDialog(UserLoginDialog userLoginDialog, StaffDAO staffDAO){
		this();
		this.staffDAO = staffDAO;
		//It"ll be used to make the dialog visible again
		this.loginDialog = userLoginDialog;
	}
	...
	private void createCustomer(){
		...
		Staff staff = new Staff(firstName, lastName, email, password);
		
		try {
			staffDAO.addStaff(staff);
			JOptionPane.showMessageDialog(loginDialog, "Staff created successfully",
